...
public class ModernRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    public ModernRefreshHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ModernRefreshHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
//        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(
//                R.layout.layout_refresh_header, null);

package blog.csdn.net.mchenys.common.glide;
...
import blog.csdn.net.mchenys.common.glide.linstener.BitmapLoadingListener;
import blog.csdn.net.mchenys.common.glide.linstener.LoaderListener;
import blog.csdn.net.mchenys.common.glide.module.SimpleGlideModule;
import blog.csdn.net.mchenys.common.glide.transformation.BlurTransformation;
import blog.csdn.net.mchenys.common.glide.transformation.CropCircleTransformation;
import blog.csdn.net.mchenys.common.glide.transformation.GrayscaleTransformation;
import blog.csdn.net.mchenys.common.glide.transformation.RotateTransformation;
import blog.csdn.net.mchenys.common.glide.transformation.RoundedCornersTransformation;
import blog.csdn.net.mchenys.common.utils.PathUtils;
...
public class ImageLoader {
     ...
     * raw资源："android.resource://[packageName]/raw/raw_1"或"android.resource://[packageName]/raw/"+R.raw.raw_1<p/>
     * drawable资源："android.resource://[packageName]/drawable/news"或load"android.resource://[packageName]/drawable/"+R.drawable.news<p/>
    ...
    private static void load(Context context, ImageView view, Object objUrl, ImageLoadConfig config, final LoaderListener listener) {
        ...
        try {
            ...
            if (config.isAsGif()) {//gif类型
                ...
                //transform bitmap
                if (config.isRoundedCorners()) { //圆角
                    int radius = config.getCornerRadius() == 0 ? 50 : config.getCornerRadius();
                    int margin = config.getCornerMargin() == 0 ? 50 : config.getCornerMargin();
                    request.transform(new RoundedCornersTransformation(context, radius, margin));
    ...
    public static synchronized long getDiskCacheSize(Context context) {
        long size = 0L;
        File cacheDir = PathUtils.getDiskCacheDir(context, "glide_image");

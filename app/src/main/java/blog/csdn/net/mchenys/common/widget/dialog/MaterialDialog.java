...
//7
            ...
            if (mLayoutParams != null && mPositiveButton != null) {
                if (mButtonLayout.getChildCount() > 0) {
                    mLayoutParams.setMargins(dip2px(BUTTON_BOTTOM), dip2px(BUTTON_BOTTOM),
                            dip2px(20), dip2px(BUTTON_BOTTOM));
                    mPositiveButton.setLayoutParams(mLayoutParams);
                    mButtonLayout.addView(mPositiveButton, 1);
                } else {
                    mPositiveButton.setLayoutParams(mLayoutParams);

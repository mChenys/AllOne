...
public class VideoView extends SurfaceView implements MediaPlayerControl {
    ...
    public void setVideoURI(Uri uri, Map<String, String> headers) {
        LogUtils.e("cys", this.hashCode() + "->setVideoURI");
        mUri = uri;
        mHeaders = headers;
        mSeekWhenPrepared = 0;
        openVideo();
...
//            mMediaPlayer.setDataSource(mContext, mUri, mHeaders);
    ...
    MediaPlayer.OnPreparedListener mPreparedListener = new MediaPlayer.OnPreparedListener() {
        public void onPrepared(MediaPlayer mp) {
            ...
            //这里注释掉,因为这部分判断是针对性能很差的机型做的判断.解开会爆红,也不影响使用
...
//            }
    ...
    SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback() {
        public void surfaceChanged(SurfaceHolder holder, int format,
                                   int w, int h) {
            LogUtils.e("cys", VideoView.this.hashCode() + "->surfaceChanged");
            mSurfaceWidth = w;
            mSurfaceHeight = h;
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            LogUtils.e("cys", VideoView.this.hashCode() + "->surfaceCreated");
        ...
        public void surfaceDestroyed(SurfaceHolder holder) {
            ...
            LogUtils.e("cys", VideoView.this.hashCode() + "->surfaceDestroyed");
            mSurfaceHolder = null;
    ...
    @Override
    public void start() {
        LogUtils.e("cys", this.hashCode() + "->start");

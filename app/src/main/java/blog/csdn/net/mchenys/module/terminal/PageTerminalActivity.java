...
public class PageTerminalActivity extends BaseActivity implements View.OnFocusChangeListener, View.OnClickListener {
    ...
    protected Integer getLayoutResID() {
        return R.layout.activity_page_terminal;
    }

    @Override
    public void setTitleBar(TitleBar titleBar) {
        titleBar.setCenterTv("详情页");
        titleBar.setRightIcon1(R.drawable.ic_menu_more, new View.OnClickListener() {
            @Override

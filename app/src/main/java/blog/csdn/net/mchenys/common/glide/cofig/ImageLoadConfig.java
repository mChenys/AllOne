package blog.csdn.net.mchenys.common.glide.cofig;
...
public class ImageLoadConfig {
    ...
    private ImageLoadConfig(Builder builder) {
        ...
        this.cornerMargin = builder.cornerMargin;
    ...
    public static class Builder {
        ...
        public Builder setCornerMargin(int cornerMargin) {
    ...
    public static Builder parseBuilder(ImageLoadConfig config) {
        ...
        builder.cornerMargin = config.cornerMargin;
